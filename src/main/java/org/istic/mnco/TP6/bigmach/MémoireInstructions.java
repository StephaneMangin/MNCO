 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class MémoireInstructions {
	...
	public static int inst (int ou) throws BigMachException {
		if (ou < 0 || ou > tailleInsts - 1) {throw (new BigMachException (BigMachException.BM_ACCES_HORS_INSTS)) ; }
		return tInsts[ou] ;
	...
	public static void décompiler (int de, int a) {
		int i = de ;
