...
public class Génération {
	...
	public static void ecrire () throws BigLangException {
		...
		objet.modifie(Ce, CodesInstructions.CODE_ÉCRIRE) ; Ce++ ;
		objet.modifie(Ce, enAscii) ; Ce++ ;
	...
	public static void genNon () throws BigLangException {
		if (cEstUnRepère) { objet.modifie(Ce, CodesInstructions.CODE_VALEUR) ; Ce++ ;}
		cEstUnRepère = false ;
	...
	public static void opérandeGaucheAff () throws BigLangException {	
		if (!cEstUnRepère) {throw new BigLangException(BigLangException.BL_SEM, BigLangException.BL_SEM_VAL_A_GAUCHE_AFF) ;};
	...
	public static void finAlors () throws BigLangException {
		...
		objet.modifie(Ce, CodesInstructions.CODE_NOP) ; Ce++ ;	// pour évent. netraliser ou dérepérer
	...
	public static void finSinon () throws BigLangException {
		...
		case TYPE_NEUTRE:					// neutraliser le sinon
			if (typeCourant != TYPE_NEUTRE) {
				objet.modifie(Ce, CodesInstructions.CODE_DÉPILER) ; Ce++ ;
